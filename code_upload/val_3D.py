...
def var_all_case_LA(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    for image_path in loader:
        ...
        image = h5f['image'][:]
        label = h5f['label'][:]
        prediction, score_map = test_single_case_LA(model, image, stride_xy, stride_z, patch_size, num_classes=num_classes)
...
def test_single_case_LA(model, image, stride_xy, stride_z, patch_size, num_classes=1):
    w, h, d = image.shape
