...
parser.add_argument('--root_path', type=str,
                    default='/hy-tmp/zx/dataset/LA', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='LA/Unco', help='experiment_name')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 2000 and iter_num % 200 == 0:
                model1.eval()
                dice_sample1 = test_3d_patch.var_all_case_LA(model1, num_classes=num_classes, patch_size=args.patch_size, stride_xy=18, stride_z=4)
                ...
                model2.eval()
                dice_sample2 = test_3d_patch.var_all_case_LA(model2, num_classes=num_classes, patch_size=args.patch_size, stride_xy=18, stride_z=4)
...
if __name__ == "__main__":
    ...
    # for test
    os.system("python test_LA.py --exp {} --labeled_num {} --strategy val".format(args.exp, args.labeled_num))
    os.system("python test_LA.py --exp {} --labeled_num {} --strategy both".format(args.exp, args.labeled_num))
