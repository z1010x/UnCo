...
parser.add_argument('--exp', type=str,
                    default='BraTS2019/Unco', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=25, # 25(10%) 50(20%)
                    help='labeled data')
# costs
...
if __name__ == "__main__":
    ...
    # for test
    os.system("python test_Brats.py --exp {} --labeled_num {} --strategy val".format(args.exp, args.labeled_num))
    os.system("python test_Brats.py --exp {} --labeled_num {} --strategy both".format(args.exp, args.labeled_num))
