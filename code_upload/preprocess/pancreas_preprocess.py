...
if __name__ == '__main__':
    ...
    parser.add_argument('--raw_data_dir', type=str, default='../../data/raw_dataset/Pancreas-CT', help='Name of Experiment')
    parser.add_argument('--raw_label_dir', type=str, default='../../data/raw_dataset/TCIA_pancreas_labels-02-05-2017', help='image_list_path')
    ...
    covert_h5(args.raw_data_dir, args.raw_label_dir, training_volume_ids, to_dir_train, True,  crop_first_norm_last=True)
    # to build test set
    to_dir_test = '../../data/Pancreas-CT-all'
    if not os.path.exists(to_dir_test):
        os.makedirs(to_dir_test)
    covert_h5(args.raw_data_dir, args.raw_label_dir, test_volume_ids, to_dir_test, True, crop_first_norm_last=True)